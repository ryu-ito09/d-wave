angle = [0,0,4;0,0,4;1,1,3;1,2,3;2,3,3;3,3,2;3,3,2;]
close all;
f1 = figure;
...
for i=1:l
    ...
    p.Color = "blue";
    hold on;
    p_o = plot3(xo1,yo1,zo,"-r","LineWidth",10);
    p_o.Color = "red";
    p_o = plot3(xo2,yo2,zo,"-r","LineWidth",10);
    p_o.Color = "red";
    p_o = plot3(xo3,yo3,zo,"-r","LineWidth",10);
    p_o.Color = "red";
    p_o = plot3(xo4,yo4,zo,"-r","LineWidth",10);
    p_o.Color = "red";
    p_o = plot3(xo5,yo5,zo,"-r","LineWidth",10);
    p_o.Color = "red";
    p_o = plot3(xo6,yo6,zo,"-r","LineWidth",10);
    p_o.Color = "red";
    p_o = plot3(xo7,yo7,zo,"-r","LineWidth",10);
    p_o.Color = "red";
    p_o = plot3(xo8,yo8,zo,"-r","LineWidth",10);
    p_o.Color = "red";
    p_o = plot3(xo9,yo9,zo,"-r","LineWidth",10);
    p_o.Color = "red";
    p_o = plot3(xo10,yo10,zo,"-r","LineWidth",10);
    p_o.Color = "red";
